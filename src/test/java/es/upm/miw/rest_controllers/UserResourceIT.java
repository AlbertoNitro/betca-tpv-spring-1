...
class UserResourceIT {
    ...
    @BeforeEach
    void before() {
        userDb = this.userRepository.save(new User("999777666", "123445", "666001110","123445","10","C/ TPV, 100, 1A, 28000 Madrid","user2@gmail.com"));
    ...
    void testreadMobileUserNameDniByAdmin() {
        ...
        userQueryInputDto.setDiscount(userDto.getDiscount());
